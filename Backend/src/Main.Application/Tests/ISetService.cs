...
public interface ISetService
{
    ...
    Task UpdateSetAsync(UpdateSetRequest updateSetRequest, CancellationToken cancellationToken);
    
    Task DeleteSetAsync(Guid id, CancellationToken cancellationToken);
    
    Task<GetSetsResponse?> GetMySetsAsync(Guid userId, CancellationToken cancellationToken);
    
    Task<GetSetsResponse?> GetFavoriteSetsAsync(Guid userId, CancellationToken cancellationToken);
}